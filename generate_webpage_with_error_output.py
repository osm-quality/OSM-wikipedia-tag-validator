...
def generate_shared_test_results_page(cursor, all_timestamps):
    query = "SELECT rowid, type, id, lat, lon, tags, area_identifier, download_timestamp, validator_complaint, error_id FROM osm_data WHERE validator_complaint IS NOT NULL AND validator_complaint <> '' AND download_timestamp > 1688480000"
    query_parameters = {}
